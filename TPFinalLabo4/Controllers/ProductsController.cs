...
using TPFinalLabo4.Data;
using TPFinalLabo4.Models;

namespace TPFinalLabo4.Controllers
{
    [Authorize]
    public class ProductsController : Controller
    {
        ...
        //private void  UpdateProductSupplier(string[] selectedSuppliers, Product product)
        //{
        //    if (selectedSuppliers == null)
        //    {
        //        product.SupplierProduct = new List<SupplierProduct>();
        ...
        //    var selectedSuppliersHS = new HashSet<string>(selectedSuppliers);
        //    var productSuppliersHS = new HashSet<int>(product.SupplierProduct.Select(p => p.SupplierId));

        //    foreach (var suppliersProduct in _context.SuppliersProducts)
        //    {
        //        if (selectedSuppliersHS.Contains(suppliersProduct.SupplierId.ToString()))
        //        {
        //            if (!productSuppliersHS.Contains(suppliersProduct.SupplierId))
        //            {
        //                SupplierProduct newSupplierProduct = new SupplierProduct { Product = product, Supplier = suppliersProduct.Supplier, ProductId = product.Id, SupplierId = suppliersProduct.SupplierId };
        //                productSuppliersHS.Add(suppliersProduct.SupplierId);
        //                product.SupplierProduct.Add(newSupplierProduct);
        //            }
        //        }
        //        else
        ...
        //            if (productSuppliersHS.Contains(suppliersProduct.SupplierId))
        //            {
        //               var pepe = product.SupplierProduct.Remove(suppliersProduct);
        //            }
        //        }
        //    }
        //}
